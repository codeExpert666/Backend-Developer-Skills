...
本文是 [[EventHub 工程实践总览]] 下的 AI 应用开发维度入口，负责把 [[AI 应用开发学习路线图]] 映射到 EventHub Java 与 Go 两个后端项目，是活动票务场景、双仓库业务门槛和最终交付物的唯一项目路线图。
...
EventHub 的业务开发、工程化交付和 AI 应用开发是三条相关但不同的实践路线，完整关系与统一称谓由 [[EventHub 工程实践总览]] 维护。本文只引用以下阶段与工程依赖：
